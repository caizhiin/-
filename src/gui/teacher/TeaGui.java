...
public class TeaGui extends JFrame {
    ...
    public static void main(String[] args) {
        new TeaGui("1999020100");
    }
    public TeaGui(String id) {
        ...
        try {
            ...
            String strSQL = "select course.cno,course.cname\n" +
                    "from teacher left join course on course.cno = teacher.class\n" +
                    "where teacher.tno = ?";
        ...
        try {
            ...
            String strSQL1 = "select * from teacher where tno = ?";
            ...
            jb11.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    try {
                        ...
                        String strSQL2 = "UPDATE teacher SET tno = ?,tname = ?,tsex = ?, tage = ?,class = ? WHERE id = ?";
                        ...
                        st2.executeUpdate();
                        JOptionPane.showMessageDialog(TeaGui.this, "提交成功");
                        dbConn.close();

                    } catch (Exception ee) {
                        ee.printStackTrace();
                        JOptionPane.showMessageDialog(TeaGui.this, "数据不合法");
                    }
                }
            });
        ...
        jp31.add(jb32);
        String[][] datas3 = {};
        String[] titles3 = { "课程号", "课程名" ,"学号","姓名","成绩"};
        ...
        columnModel3.getColumn(4).setPreferredWidth(100);
        ...
        try {
            ...
            Connection dbConn = DriverManager.getConnection(URL, user, password);
            System.out.println("连接数据库成功");
            String strSQL = "select course.cno,course.cname,student.sno,student.sname,sc.grade\n" +
                    "from dbo.sc left join course on sc.cno = course.cno left join teacher on sc.cno = teacher.class left join student on sc.sno = student.sno\n" +
                    "where teacher.tno = ?";
            PreparedStatement st = dbConn.prepareStatement(strSQL);
            st.setString(1,id);
            ResultSet rs = st.executeQuery();
